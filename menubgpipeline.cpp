...
bool menubgpipeline::init(vkobjs& objs, VkPipelineLayout& playout, VkPipeline& pipeline, VkPrimitiveTopology topology, std::string vname, std::string fname){
    VkShaderModule vertexModule = vkshader::loadshader(objs.rdvkbdevice.device, vname);
    VkShaderModule fragmentModule = vkshader::loadshader(objs.rdvkbdevice.device, fname);
...
void menubgpipeline::cleanup(vkobjs& objs, VkPipeline& pipeline) {
