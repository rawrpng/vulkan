...
bool gltfskeletonpipeline::init(vkobjs& objs, VkPipelineLayout& pipelineLayout,
    ...
    mainBinding.stride = sizeof(vkvert);
    ...
    positionAttribute.offset = offsetof(vkvert, pos);

    VkVertexInputAttributeDescription colorAttribute{};
    colorAttribute.binding = 0;
    colorAttribute.location = 1;
    colorAttribute.format = VK_FORMAT_R32G32B32_SFLOAT;
    colorAttribute.offset = offsetof(vkvert, col);

    VkVertexInputAttributeDescription uvAttribute{};
    uvAttribute.binding = 0;
    uvAttribute.location = 2;
    uvAttribute.format = VK_FORMAT_R32G32_SFLOAT;
    uvAttribute.offset = offsetof(vkvert, uv);
...
void gltfskeletonpipeline::cleanup(vkobjs& objs, VkPipeline& pipeline) {
